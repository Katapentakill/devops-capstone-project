...
class TestAccountService(TestCase):
    ...
    def test_read_an_account(self):
        ...
        account = AccountFactory()
        created = self.client.post(BASE_URL, json=account.serialize(), content_type="application/json")
    ...
    def test_list_accounts(self):
        ...
        account = AccountFactory()
        self.client.post(BASE_URL, json=account.serialize(), content_type="application/json")
        self.client.post(BASE_URL, json=AccountFactory().serialize(), content_type="application/json")
        response = self.client.get(BASE_URL)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        data = response.get_json()
    ...
    def test_update_an_account(self):
        ...
        updated_data["phone_number"] = "555-1111"
    ...
    def test_delete_account_not_found(self):
        """It should return 204 when deleting a non-existent Account (idempotent)"""
        response = self.client.delete(f"{BASE_URL}/0")
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)

    def test_method_not_allowed(self):
        """It should not allow invalid method on an endpoint"""
